              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="text-sm flex items-center mt-5   ">
                  ...
                  <a
                    ...
                    className="mr-3 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                    <Image
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      href="https://new-volgograd.ru/events/events.html"
                      className="mb-6 inline-block text-xs text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      События
                    </Link>
                  ...
                  <li>
                    <Link
                      href="https://new-volgograd.ru/news/volganews.html"
